...
export const Icons = {
    JarvisLogo: (props: React.SVGProps<SVGSVGElement>) => (
        <img
            width={20}
            height={20}
            src="https://s3plus.meituan.net/zspt-fe/jarvis/xiaomi.png"
            alt="logo"
        />
    ),
    ThumbsUp: (props: React.SVGProps<SVGSVGElement>) => (
        ...
        >
            <path
                d="M4.2 14.8H3C2.5134 14.8 2.2 14.4866 2.2 14V8.2C2.2 7.7134 2.5134 7.4 3 7.4H4.2M9.2 6V3.4C9.2 2.4716 8.3284 1.8 7.4 1.8L4.2 8V14.8H12.7432C13.1577 14.8041 13.5509 14.6745 13.7414 14.4414C13.932 14.2083 14.0023 13.8956 13.9296 13.5932L12.9363 8.39315C12.8615 8.07528 12.5798 7.84572 12.15 7.84572H9.2"
                stroke="currentColor"
                strokeWidth="1.3"
                strokeLinecap="round"
    ...
    ThumbsUpFilled: (props: React.SVGProps<SVGSVGElement>) => (
        <svg
            width="16"
            height="16"
            viewBox="0 0 18 18"
            ...
            {...props}
        >
            <path d="M4.2 14.8H3C2.5134 14.8 2.2 14.4866 2.2 14V8.2C2.2 7.7134 2.5134 7.4 3 7.4H4.2M9.2 6V3.4C9.2 2.4716 8.3284 1.8 7.4 1.8L4.2 8V14.8H12.7432C13.1577 14.8041 13.5509 14.6745 13.7414 14.4414C13.932 14.2083 14.0023 13.8956 13.9296 13.5932L12.9363 8.39315C12.8615 8.07528 12.5798 7.84572 12.15 7.84572H9.2" />
        </svg>
    ),
    ThumbsDown: (props: React.SVGProps<SVGSVGElement>) => (
        ...
        >
            <path
                d="M13.8 3.2H15C15.4866 3.2 15.8 3.5134 15.8 4V9.8C15.8 10.2866 15.4866 10.6 15 10.6H13.8M8.8 12V14.6C8.8 15.5284 9.6716 16.2 10.6 16.2L13.8 10V3.2H5.25685C4.94229 3.19585 4.64907 3.32555 4.45855 3.55865C4.26803 3.79175 4.19766 4.10439 4.27043 4.40677L5.26374 9.60685C5.33846 9.92472 5.62021 10.1543 5.95 10.1543H8.8"
                stroke="currentColor"
                strokeWidth="1.3"
                strokeLinecap="round"
                strokeLinejoin="round"
    ...
    ThumbsDownFilled: (props: React.SVGProps<SVGSVGElement>) => (
        <svg
            width="16"
            height="16"
            viewBox="0 0 18 18"
            ...
            {...props}
        >
            <path d="M13.8 3.2H15C15.4866 3.2 15.8 3.5134 15.8 4V9.8C15.8 10.2866 15.4866 10.6 15 10.6H13.8M8.8 12V14.6C8.8 15.5284 9.6716 16.2 10.6 16.2L13.8 10V3.2H5.25685C4.94229 3.19585 4.64907 3.32555 4.45855 3.55865C4.26803 3.79175 4.19766 4.10439 4.27043 4.40677L5.26374 9.60685C5.33846 9.92472 5.62021 10.1543 5.95 10.1543H8.8" />
        </svg>
    ),
    ZsptLogo: ({ className, ...props }: IconProps) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={22}
            height={22}
    ...
    ZsptIcon: ({ className, ...props }: IconProps) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={22}
            height={22}
    ...
    ZsptTextLogo: ({ className, ...props }: IconProps) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={139}
            height={17}
    ...
    ChatMessage: ({ className, ...props }: IconProps) => (
        <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        >
            <path
                d="M14 2H2C1.44772 2 1 2.44772 1 3V11C1 11.5523 1.44772 12 2 12H5.5L8 14.5L10.5 12H14C14.5523 12 15 11.5523 15 11V3C15 2.44772 14.5523 2 14 2Z"
                stroke="currentColor"
                strokeWidth="1.2"
                strokeLinecap="round"
                strokeLinejoin="round"
            />
            <path d="M4.5 6H11.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
            <path d="M4.5 8.5H8.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
        </svg>
    ),
    RegisterIcon: (props: IconProps) => (
        <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
