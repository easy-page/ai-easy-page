...
export default {
	...
	darkMode: ['class'],
	safelist: ['dark', 'light', 'blue', 'yellow'],
	theme: {
		container: {
			center: true,
			padding: '2rem',
		...
		extend: {
			colors: {
				background: {
					...
					brand: {
						...
						tertiary: 'hsl(var(--background-brand-tertiary))',
					},
					primary: 'hsl(var(--background-primary))',
					secondary: 'hsl(var(--background-secondary))',
					'tertiary-light': 'hsl(var(--background-tertiary-light))',
					...
					'success-light': 'hsl(var(--background-success-light))',
					'error-light': 'hsl(var(--background-error-light))',
				},
				foreground: {
					DEFAULT: 'hsl(var(--foreground))',
					brand: 'hsl(var(--foreground-brand))',
					'brand-hover': 'hsl(var(--foreground-brand-hover))',
					...
					'hover-contrast': 'hsl(var(--foreground-hover-contrast))',
			...
			animation: {
				...
				'menu-appear': 'menu-appear 0.2s ease-out forwards',
			},
		},
	},
