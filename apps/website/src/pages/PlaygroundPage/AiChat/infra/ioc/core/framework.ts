...
export class Framework {
    private readonly components: Map<string, Map<string, Map<ComponentVariant, ComponentFactory>>> =
        new Map();
    ...
    addValue<T>(
        ...
        value: T,
        { scope, override }: { scope?: FrameworkScopeStack; override?: boolean } = {},
    ) {
...
class FrameworkEditor {
    ...
    service = <
        ...
        Deps = Arg1 extends Type<ServiceType> ? TypesToDeps<ConstructorParameters<Arg1>> : [],
    >(
        service: Arg1,
    ...
    store = <
        ...
        Deps = Arg1 extends Type<StoreType> ? TypesToDeps<ConstructorParameters<Arg1>> : [],
    >(
        store: Arg1,
        ...[arg2]: Arg2 extends [] ? [] : [Arg2]
    ): this => {
    ...
    entity = <
        ...
        Deps = Arg1 extends Type<EntityType> ? TypesToDeps<ConstructorParameters<Arg1>> : [],
    >(
        entity: Arg1,
        ...[arg2]: Arg2 extends [] ? [] : [Arg2]
    ): this => {
    ...
    impl = <
        ...
        Deps = Arg2 extends Type<Trait> ? TypesToDeps<ConstructorParameters<Arg2>> : [],
    >(
        identifier: Arg1,
        arg2: Arg2,
    ...
    scope = (scope: Type<Scope<any>>): this => {
        this.currentScopeStack = [...this.currentScopeStack, parseIdentifier(scope).identifierName];

        this.collection.addFactory<any>(scope as any, dependenciesToFactory(scope, [] as any), {
            scope: this.currentScopeStack,
            override: true,
        });
