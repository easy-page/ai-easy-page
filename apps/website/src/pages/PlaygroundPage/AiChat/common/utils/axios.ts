...
export const aiPostReq = (url: string, data: any) => {
	return postReq(
		`/zspt-admin-api/ai/req`,
		{
			url: `https://aigc.sankuai.com${url}`,
			method: 'POST',
			params: {
				...data,
				env: getEnv(),
...
export const aiPostFormReq = (url: string, data: any) => {
	return postReq(
		`/zspt-admin-api/ai/req`,
		{
			url: url,
...
export const aiGetReq = (url: string, data: any) => {
	return postReq(
		`/zspt-admin-api/ai/req`,
		{
			url: `https://aigc.sankuai.com${url}`,
