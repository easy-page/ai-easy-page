...
interface RadioGroupConfigPanelProps {
	props: RadioGroupPropsSchema['properties'];
	onChange: (props: RadioGroupPropsSchema['properties']) => void;
}

const RadioGroupConfigPanel: FC<RadioGroupConfigPanelProps> = ({
	props,
	onChange,
}) => {
...
export default RadioGroupConfigPanel;
